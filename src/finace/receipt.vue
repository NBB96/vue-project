  ...
  <el-main>
    <el-row>
      <el-breadcrumb separator-class="el-icon-arrow-right" class="t">
        ...
        <el-breadcrumb-item :to="{ path: '/receipt' }">财务收支</el-breadcrumb-item>
      ...
      <el-tab-pane label="货到付款" name="1">
        <el-table bsale :data="sale">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="end(scope.row)">收款</el-button>
    ...
    <!-- 收款登记 -->
    <el-dialog el-dialog title="销售单详细信息" :visible.sync="dialogVisible" width="60%">
      <el-table border :data="rep">
        ...
        <el-table-column label="预付款方式" v-if="t==2">
          <template slot-scope="scope">
            <span v-if="scope.row.status==2">收余款</span>
            <span v-if="scope.row.status==1">收预付款</span>
          </template>
        </el-table-column>
      </el-table>
    </el-dialog>
